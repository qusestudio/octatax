...
export default function OurProcessPreview () {
    return (
        <section className="w-full px-[20%] max-sm:gap-y-5 max-sm:px-[5%] bg-white  items-center max-sm:items-start flex gap-y-10 py-20 flex-col ">
            <p className={"text-[#038EF0] max-sm:text-sm font-bold"}>OUR PROCESS</p>
            <h3 className="text-4xl max-sm:text-2xl  text-center max-sm:text-left font-bold text-[#0B0331]">
                Our Roadmap to <br/>
